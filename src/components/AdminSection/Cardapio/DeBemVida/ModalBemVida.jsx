...
const ModalBemVida = ({ isOpen, onRequestClose, contentLabel }) => {
    ...
    >
      <div className="bg-white p-6 shadow-lg w-full max-w-[90vw] md:max-w-[600px] 2xl:max-h-[956px] md:max-h-[80vh] overflow-auto mx-auto pt-[70px]">
        <div className="flex flex-col items-center w-full">
          ...
          <h1 className="text-[16px] md:text-[18px] font-semibold mb-4 mt-2">De Bem Com a Vida</h1>
          ...
          <form className='w-full flex flex-col px-[10px] md:px-[20px]' onSubmit={handleSubmit}>
            ...
            <div className="flex justify-center my-[20px]">
              <button
                type="submit"
                className="px-6 py-2 bg-[#00884A] text-white text-[15px] md:text-[17px] shadow-sm hover:bg-[#226849]"
              >
                Salvar
              </button>
            </div>
